...
/* harmony export */   replaceValidSign: () => (/* binding */ replaceValidSign)
/* harmony export */ });
function replaceValidSign(expression, sign) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   reverseModuleNumber: () => (/* binding */ reverseModuleNumber)
/* harmony export */ });
function reverseModuleNumber(num) {
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _script_helperFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _script_reverseModuleNumber_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
reverseModule.addEventListener('click', function () {
   if(input.value == firstNum) {
    ...
    const res = (0,_script_reverseModuleNumber_js__WEBPACK_IMPORTED_MODULE_1__.reverseModuleNumber)(firstNum);
    firstNum = res
    input.value = res
  }
  else {
    const res = (0,_script_reverseModuleNumber_js__WEBPACK_IMPORTED_MODULE_1__.reverseModuleNumber)(secondNum);
    secondNum = res
    input.value = res
  }
});
...
compute.addEventListener('click', function () {
  if (firstNum && sign && secondNum) {
    ...
    try {
      const newExpression = (0,_script_helperFunctions_js__WEBPACK_IMPORTED_MODULE_0__.replaceValidSign)(expression, sign);
